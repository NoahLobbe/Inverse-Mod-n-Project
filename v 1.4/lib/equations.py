...
class Equation:
    ...
    def substitute(self, equToSubIn):#, var_to_sub_in_by):
        ...
        #print("LHS_key", var_to_sub_in_by)
        #equToSubIn.simplify() distrupts values
        print("equToSubIn:", equToSubIn.str)
        print("target equation:", self.str)

        if  self.isVarPresent(var_to_sub_in_by): #equToSubIn.isVarPresent(var_to_sub_in_by) and
            ...
            print("var_to_sub_in_by:", var_to_sub_in_by, "NOT present in both sides of target equation")
